...
\subsection{Exploration préalable des données}\label{exploration-prealable-des-donnees}}
...
\hypertarget{un-seul-echantillon}{%
\subsubsection{Un seul échantillon}\label{un-seul-echantillon}}
...
Ici, l'axe des abscisses n'a aucun sens. Nous n'avons qu'une unique série de données, l'axe des \texttt{x} est donc inutile. On peut le retirer :
...
\begin{center}\includegraphics[width=0.25\linewidth]{figure/unnamed-chunk-18-1} \end{center}

\hypertarget{plusieurs-echantillons}{%
\subsubsection{Plusieurs échantillons}\label{plusieurs-echantillons}}
