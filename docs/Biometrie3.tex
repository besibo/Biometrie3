...
\NormalTok{Testo\_long }\OtherTok{\textless{}{-}}\NormalTok{ Testo\_large }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Traitement =} \FunctionTok{factor}\NormalTok{(Traitement))}
...
1 ID            After              0             1 FALSE         13
2 ID            Before             0             1 FALSE         13
  top_counts            
1 1: 1, 2: 1, 3: 1, 4: 1
2 1: 1, 2: 1, 3: 1, 4: 1
...
1 DO            After              0             1  4.79 0.262  4.3    4.6  4.96
2 DO            Before             0             1  4.73 0.280  3.91   4.7  4.8 
    p75  p100 hist 
1  5     5.02 ▂▁▂▁▇
2  4.88  4.98 ▁▁▁▃▇
\end{verbatim}
