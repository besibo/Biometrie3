...
Les données de \citet{wiseman1996} sont disponibles dans le fichier \texttt{ropetrick.csv}. Importez ces données et analysez-les en respectant les consignes de l'exercice précédent.
...
\hypertarget{importation-et-examen-visuel-5}{%
\paragraph{Importation et examen visuel}\label{importation-et-examen-visuel-5}}

\hypertarget{statistiques-descriptives-5}{%
\paragraph{Statistiques descriptives}\label{statistiques-descriptives-5}}

\hypertarget{exploration-graphique-5}{%
\paragraph{Exploration graphique}\label{exploration-graphique-5}}
...
\paragraph{Conditions d'application}\label{conditions-dapplication-5}}
...
\hypertarget{intervalle-de-prediction-de-la-regression}{%
\paragraph{Intervalle de prédiction de la régression}\label{intervalle-de-prediction-de-la-regression}}
...
\paragraph{Transformation des données}\label{transformation-des-donnees}}

\hypertarget{autres-methodes}{%
\paragraph{Autres méthodes}\label{autres-methodes}}
