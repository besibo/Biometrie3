...
\hypertarget{realisation-du-test-et-interpretation-4}{%
\paragraph{Réalisation du test et interprétation}\label{realisation-du-test-et-interpretation-4}}

\hypertarget{tests-post-hoc-1}{%
\paragraph{Tests Post-Hoc}\label{tests-post-hoc-1}}

\hypertarget{exercice-dapplication-4}{%
\subsubsection{Exercice d'application}\label{exercice-dapplication-4}}
