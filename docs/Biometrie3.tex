...
\subsection{Corrélation}\label{correlation-1}}
...
-- Variable type:numeric -----
    variable missing complete  n mean   sd p0  p25  p50  p75 p100
 inbreedCoef       0       24 24 0.23 0.1   0 0.19 0.24 0.3   0.4
       nPups       0       24 24 3.96 1.88  1 3    3    5.25  8  
     hist
 ▂▁▃▃▇▅▁▃
 ▁▃▇▃▂▃▂▁
\end{verbatim}
...
\hypertarget{les-miracles-de-la-memoire-1}{%
\subsubsection{Les miracles de la mémoire}\label{les-miracles-de-la-memoire-1}}
...
\hypertarget{regression-lineaire-1}{%
\subsection{Régression linéaire}\label{regression-lineaire-1}}
...
-- Variable type:numeric -----
             variable missing complete  n mean   sd   p0  p25  p50
 FaceWidthHeightRatio       0       21 21 1.81 0.12 1.59 1.74 1.79
       PenaltyMinutes       0       21 21 1.28 0.71 0.14 0.85 1.23
  p75 p100     hist
 1.87 2.07 ▂▁▇▇▂▂▂▁
 1.57 2.95 ▅▁▅▇▂▂▁▁
\end{verbatim}
