...
Ici, la $p$-value du premier test est supérieure à $\alpha = 0.05$. Il n'y a dons pas de différence entre les médianes du groupe `control` et du groupe `knee`. Le traitement lumineux appliqué dans le creux poplité n'a donc aucun effet sur le décalage de phase.
