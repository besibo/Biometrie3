...
\textsc{Robinson D, Hayes A, \& Couch S}. (2021). \emph{Broom: Convert statistical objects into tidy tibbles}. Retrieved from \url{https://CRAN.R-project.org/package=broom}
...
\textsc{Wickham H, \& Hester J}. (2021). \emph{Readr: Read rectangular text data}. Retrieved from \url{https://CRAN.R-project.org/package=readr}
